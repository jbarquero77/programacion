...
* por lo que si hacen novillos no van a clase pero aunque no vayan quedara registrado en el aula 
* (como que cada uno tiene su sitio).
...
Si se puede dar clase mostrar cuantos alumnos y alumnas (por separado) están aprobados de momento 
* (imaginad que les están entregando las notas).
 ...
 * 
 */
public class AlumnosYProfesores {
